from sqlalchemy import Column, Integer, DateTime, ForeignKey, Numeric, String, Boolean, func, UniqueConstraint
...
class Sales(Base):
    ...
    txn_id = Column(String(36), nullable=True, index=True)
    ...
    __table_args__ = (
        UniqueConstraint('txn_id', 'stock_id', name='uq_sales_txn_id_stock_id'),
    )